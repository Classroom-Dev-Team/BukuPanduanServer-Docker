...
\title{\Huge \textbf{Buku Panduan Docker}  \footnote{This is a footnote.} \\ \huge Docker \footnote{This is yet another footnote.}}
% Author
\author{\textsc{Classroom Dev Team}\thanks{\url{www.example.com}}}
...
%input{chapter/introductory_chapter.tex}
\input{chapter/tentang_docker.tex}
\input{chapter/instalasi_docker.tex}
\input{chapter/build_aplikasi_dan_run_pada_docker.tex}
\input{chapter/upload_dan_pull_image.tex}
\input{chapter/docker_volume.tex}
\input{chapter/memanipulasi_file_dengan_docker_volume.tex}
\input{chapter/docker_network.tex}
\input{chapter/menghubungkan_aplikasi_docker_network.tex}
\input{chapter/perbedaan_docker_version.tex}
\input{chapter/tentang_docker_hub.tex}
